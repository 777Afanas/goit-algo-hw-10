# -*- coding: utf-8 -*-  # кодування файлу для коректного відображення коментарів українською
# Мета файлу: реалізувати дві функції для видачі решти монетами та порівняти їхню ефективність.  # загальний опис
